...
<div class="page-header">
    ...
    <a href="/biblioteca-app/admin/createBook" class="btn btn-primary">
        <!-- Icono de añadir -->
        ...
        <tbody>
            ...
            if (isset($stmt) && $stmt->rowCount() > 0) {
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<a href='/biblioteca-app/admin/editBook/{$id}' class='btn btn-sm btn-warning'>Editar</a>";
                    echo "<a href='/biblioteca-app/admin/deleteBook/{$id}' class='btn btn-sm btn-danger' onclick='return confirm(\"¿Estás seguro de que quieres eliminar este libro?\");'>Eliminar</a>";
                    echo "</td>";
                    echo "</tr>";
                }
            } else {
