...
public $id, $titulo, $descripcion, $usuario_asignado_id, $libro_relacionado_id, $fecha_asignacion, $fecha_limite, $estado, $respuesta;
...
$query = "INSERT INTO " . $this->table_name . " SET titulo=:titulo, descripcion=:descripcion, usuario_asignado_id=:usuario_id, libro_relacionado_id=:libro_id, fecha_limite=:fecha_limite, estado=:estado";
...
$query = "SELECT t.id, t.titulo, t.descripcion, t.fecha_limite, t.estado, t.respuesta, l.titulo as libro_titulo FROM " . $this->table_name . " t LEFT JOIN libros l ON t.libro_relacionado_id = l.id WHERE t.usuario_asignado_id = ? ORDER BY t.fecha_asignacion DESC";
$stmt = $this->conn->prepare($query);
...
$query = "UPDATE " . $this->table_name . " SET estado = 'completada', respuesta = :respuesta WHERE id = :id AND usuario_asignado_id = :usuario_id";
$stmt = $this->conn->prepare($query);
